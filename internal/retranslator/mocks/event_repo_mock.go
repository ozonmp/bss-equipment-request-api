...
// Source: github.com/ozonmp/bss-equipment-request-api/retranslator/internal/repo (interfaces: EventRepo)
...
func (m *MockEventRepo) Lock(arg0 context.Context, arg1 *sqlx.DB, arg2 uint64) ([]model.EquipmentRequestEvent, error) {
	m.ctrl.T.Helper()
