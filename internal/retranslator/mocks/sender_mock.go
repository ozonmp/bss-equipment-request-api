...
// Source: github.com/ozonmp/bss-equipment-request-api/retranslator/internal/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *model.EquipmentRequestEvent) error {
	m.ctrl.T.Helper()
